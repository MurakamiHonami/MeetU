...
export class Report {
  ...
  get matchId(): string | undefined { return this.props.matchId; }
  get reason(): ReportReason { return this.props.reason; }
  get reasonLabel(): string { return REPORT_REASONS[this.props.reason]; }
  get detail(): string | undefined { return this.props.detail; }
