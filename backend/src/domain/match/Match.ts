...
export class Match {
  ...
  get cardAId(): string { return this.props.cardAId; }
  get cardBId(): string { return this.props.cardBId; }
  get userAId(): string { return this.props.userAId; }
  get userBId(): string { return this.props.userBId; }
  get matchedTags(): string[] { return [...this.props.matchedTags]; }
  get matchedLabels(): string[] { return [...(this.props.matchedLabels ?? this.props.matchedTags)]; }
  get matchCount(): number { return this.props.matchCount; }
  get distanceKm(): number | undefined { return this.props.distanceKm; }
  get acceptedA(): boolean { return !!this.props.acceptedA; }
  get acceptedB(): boolean { return !!this.props.acceptedB; }
